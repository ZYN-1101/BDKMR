...
from bdkmr.data import *
from bdkmr.modeling import build_model
from bdkmr.engine.hooks import EvalHookDeFRCN
from bdkmr.checkpoint import DetectionCheckpointer
from bdkmr.solver import build_lr_scheduler, build_optimizer
from bdkmr.evaluation import DatasetEvaluator, inference_on_dataset, print_csv_format, verify_results
from bdkmr.dataloader import MetadataCatalog, build_detection_test_loader, build_detection_train_loader
...
def default_setup(cfg, args):
    ...
    setup_logger(output_dir, distributed_rank=rank, name="bdkmr")
...
class DefaultTrainer(SimpleTrainer):
    ...
    def build_model(cls, cfg):
        ...
        It now calls :func:`bdkmr.modeling.build_model`.
    ...
    def build_optimizer(cls, cfg, model):
        ...
        It now calls :func:`bdkmr.solver.build_optimizer`.
    ...
    def build_lr_scheduler(cls, cfg, optimizer):
        """
        It now calls :func:`bdkmr.solver.build_lr_scheduler`.
    ...
    def build_train_loader(cls, cfg):
        ...
        It now calls :func:`bdkmr.data.build_detection_train_loader`.
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        It now calls :func:`bdkmr.data.build_detection_test_loader`.
        Overwrite it if you'd like a different data loader.
        """
